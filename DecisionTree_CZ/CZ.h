...
void Keygen(vec_ZZ_pX &C, const PKE_Para &pkePara, ZZ_pXModulus &modulus, vec_ZZ_pX &pkePk, const ZZ_pX &x);
...
void Setup(vec_ZZ_pX &hssEk_1, vec_ZZ_pX &hssEk_2, vec_ZZ_pX &C_alpha, CZ_Para &pvhssPara,
    ...
    PKE_OKDM(C_alpha, pkePara, modulus, pkePk, alpha);
    //pairing para
...
void Verify(ZZ_pX y1, ZZ_pX y2, ep_t g1T1, ep2_t g2T2, CZ_Para pvhssPara, PKE_Para pkePara, ZZ_pXModulus modulus, int &flag ) {
    fp12_t gtT1;
    fp12_t gtT2;
    fp12_t right_side;
    fp12_t left_side;fp12_new(gtT1);fp12_new(gtT2);fp12_new(right_side);fp12_new(left_side);
    bn_t y_bn;
    bn_new(y_bn);
    ZZ y_ZZ;
    ZZ_p y_ZZ_p;
